...
worklist over the :class:`core.analysis.dominators.Graph` Protocol.
...
def reaching_defs(cfg: Any) -> ReachingDefs:
    ...
    :mod:`core.analysis.dominators`: ``entry``, ``nodes()``,
    ...
    :class:`core.analysis.cfg_builder.PythonCFG` does), the entry
