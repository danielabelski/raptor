"""Ground-truth correctness gate for ``core.analysis.binary_oracle`` —
...
def test_strip_ipa_suffix_handles_gcc_clone_patterns() -> None:
    ...
    from core.analysis.binary_oracle import _strip_ipa_suffix
...
def test_nm_index_stores_qualified_no_args_form_for_cpp(
    ...
    from core.analysis.binary_oracle import _nm_symbols
...
def test_combine_verdicts_prefers_full_tier_over_symbol_only() -> None:
    ...
    from core.analysis.binary_oracle import _combine_verdicts
...
def test_codeql_cli_wires_binary_flag_to_raptor_config() -> None:
    ...
    helper_path = repo_root / "core" / "analysis" / "binary_oracle_cli.py"
